...
<table border="1.5">
<tr><th>CID</th><th>Email-Id</th><th>Grievancecategory</th><th>Grievancetype</th><th>Grievancedetails</th><th>Date</th><th>Current status</th></tr>
<?php 
//	session_start();
...
else if(($x>=30))
{
  if($rows['status']!='Under AICTE Review')
  {
    ...
    $conn->query($sql1);
            $from_add = "sangeethac@buddhablock.in"; 
            $to_add = 'sangeethapandian9@gmail.com'; //<-- put your yahoo/gmail email address here
            $subject = "Status update";
